...
- **Pricing (finalized; GMV restructured 2026-07-10):** tier ladder Builder $29 / Managed $49 / Agency $99·$199·$299 (sub-account tiers) · NO trial — charge at checkout, cancel anytime; the free build→claim→use flow IS the trial (14-day trial REMOVED 2026-07-05) · **GMV fee: flat 2% on solo tiers ($29/$49) ONLY when SF is the sales channel; 0% on agency tiers ($99+)** — the 2% is an upgrade escalator (crossover ~$3.5k/mo GMV → agency tier saves money; state the math openly), and the autopay console is a free agency-tier feature, not a tax · marketplace sale fee 5% unchanged (attached to the marketplace transaction, never the tier — no rerouting arbitrage) · the old 5→3→2 declining ladder is RETIRED. "We don't tax your work." (Supersedes the "$9/extra workspace" line above, the $19/$49/$297 tiers, and the 5→3→2 ladder.)
