...
| 2026-07-15 | Self-critique of superpowers-derived changes | Upgraded set: two-audience STOP tables, honest trigger mechanics, scorecard artifact, first-run PATTERNS interview, clone-not-copy sync; plugin packaging + public scoreboard DEFERRED until demand signal | T2 | Ship boxed subset <3h; defer list revisited when repo >100 stars or posts land | 2026-08-15 | open | yes |
| 2026-07-15 | Does the 37-lens library measurably improve answers? | Independent n=7 blind eval: NO reliable effect (4W-2L-1T, ~1.4% mean margin, identical calls both arms); maker-designed pilot (2/2) did not replicate | T2 | Before any public lift claim: 20-30 blind scenarios x3 gens x3 judges + a distilled-one-paragraph arm | 2026-08-15 | open | no |
| 2026-07-15 | V2 vs V1 head-to-head: 7 fresh blind scenarios, pre-registered >=5 rule | NO detectable quality difference (V2 3W-2L-2T, +0.43 mean margin) but V2 strictly dominates cost (0.84x tokens, 0.47x tool calls, 1/3 lines) -> KEEP V2 + 2-line hybrid patch (complete tripwires, today-runnable probe) | T2 | 3-gen rerun tracking adversary-dissent rate as mediator would settle stability; persona-adversary fingerprinted in 3 winning DIFFs | 2026-08-15 | new |
