...
export const metadata: Metadata = {
  ...
  description:
    "$29/mo flat · unlimited workspaces · 14-day free trial. No metered bills — plus a flat 2% fee only when SeldonFrame is your sales channel.",
};
        ...
        <section className="border-b border-[rgba(34,29,23,.08)] bg-[#F6F2EA] px-5 py-20 text-center md:px-8 md:py-28 lg:px-12">
          <div className="mx-auto max-w-[700px]">
            ...
            <p className="mx-auto mt-4 max-w-[54ch] text-[16px] leading-[1.55] text-[#6E665A]">
              ...
              Start with a 14-day free trial. We add a flat 2% fee only when SeldonFrame is your
