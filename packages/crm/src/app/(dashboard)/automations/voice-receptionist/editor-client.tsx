...
export function VoiceReceptionistEditor(props: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Notify phone */}
      <div className="rounded-xl border bg-card p-5">
        <h2 className="text-card-title">Message notification phone</h2>
        <p className="text-xs text-muted-foreground">
          Your personal number. When the receptionist takes a message from a
          caller, it SMSes this number so you can follow up. Leave blank to
          skip SMS notifications (messages still appear in your activity log).
        </p>
        <input
          type="tel"
          value={notifyPhone}
