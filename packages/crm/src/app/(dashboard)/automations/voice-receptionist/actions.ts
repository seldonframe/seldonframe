...
const VoiceBlueprintPatchSchema = z
  .object({
    ...
    // Owner's personal notify phone — SMSed when take_message fires.
    // Empty string = clear (no SMS). E.164 or loose format; the tool
    // normalizes before sending via sendSmsFromApi.
