...
//   --sf-green: #00897B  (SeldonFrame brand green — accent dots, links)
              ...
              {ladderTiersFor(tiers, aud).map((tier) => {
                ...
                return (
                  ...
                  >
                    ...
                    {subLabel ? (
                      <p className="text-[12.5px] font-[500] text-[#00897B]">{subLabel}</p>
                    ) : null}
                    {tier.fullWhiteLabel ? (
                    ...
                    <div className="mt-2 flex flex-col items-start gap-2">
                      {placeholder ? (
                        ...
                        <button
                          ...
                          className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-full bg-[#1F2B24] px-4 text-[13.5px] font-[500] text-[#F6F2EA] shadow-[0_1px_2px_rgba(34,29,23,.10),0_6px_16px_rgba(34,29,23,.10),inset_0_1.5px_0_rgba(255,255,255,.12)] transition-all hover:-translate-y-px disabled:cursor-not-allowed disabled:opacity-60 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#00897B]"
                        >
                          <span className="size-[7px] rounded-full bg-[#00897B]" aria-hidden />
