...
const RULES: ClassifierRule[] = [
  ...
  },
  {
    ...
    keywords: [
      ...
      "landscaping",
      "lawn care",
      // v1.2.0 — broader roofing + storm restoration keywords.
      // Previously only "roofing" / "roofer" matched, missing common
      // service-list phrasing like "roof repair", "storm damage",
      // "gutter installation", "siding".
      "roofing",
      "roofer",
      "roof ",
      "shingle",
