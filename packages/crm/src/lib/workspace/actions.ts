...
/**
 * Curated list of common timezones for the settings selector. The full
 * IANA list is overkill for the form; these 32 zones cover ~95% of
 * SeldonFrame's expected operator base (NA + EU + APAC).
 *
 * Operators on uncommon zones (e.g. America/Indianapolis) can still
 * pick their region's umbrella zone — Postgres + scheduled-trigger
 * computation use IANA semantics either way.
 */
