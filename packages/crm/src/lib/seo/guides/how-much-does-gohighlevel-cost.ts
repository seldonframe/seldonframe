...
export const guide: Guide = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Yes. SeldonFrame is **$29 per month flat** with unlimited workspaces, the first workspace free forever, no trial gate, and cancel anytime, with the AI receptionist, website, CRM, booking, reviews, and a custom domain for your own workspace all included. Client sub-accounts and a branded client portal for reselling to clients are on the Agency Starter plan, from $99/mo. It runs on your own AI keys and your own Twilio, so AI and telephony run at raw provider cost with no platform markup, which is how the price stays flat as you grow."
    }
  ],
  sources: [
