...
// SeldonFrame brand teal-green `#059669` (MKT.green), NOT the violet the Claude
...
export const BUYER_ACCENT = MKT.green; // "#059669"
...
export const BUYER = {
  ...
  shadowAccent: "0 1px 2px rgba(5, 150, 105,.20), 0 14px 30px -14px rgba(5, 150, 105,.45)",
} as const;
