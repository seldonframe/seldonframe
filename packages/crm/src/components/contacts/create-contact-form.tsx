...
export function CreateContactForm() {
  ...
  return (
    ...
    >
      <div>
        <label htmlFor="cf-first" className="mb-1 block text-sm text-muted-foreground">First name</label>
        <input id="cf-first" className="crm-input h-10 w-full px-3" name="firstName" placeholder="Jane" required />
      </div>
      <div>
        <label htmlFor="cf-last" className="mb-1 block text-sm text-muted-foreground">Last name</label>
        <input id="cf-last" className="crm-input h-10 w-full px-3" name="lastName" placeholder="Doe" />
      </div>
      <div>
        <label htmlFor="cf-email" className="mb-1 block text-sm text-muted-foreground">Email</label>
        <input id="cf-email" className="crm-input h-10 w-full px-3" name="email" type="email" placeholder="jane@example.com" />
      </div>
      <div>
        <label htmlFor="cf-status" className="mb-1 block text-sm text-muted-foreground">Status</label>
