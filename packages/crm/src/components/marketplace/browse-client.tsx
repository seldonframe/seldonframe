            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 10,
                  cursor: "pointer",
                  boxShadow: "0 6px 16px rgba(31, 43, 36,0.26)",
                }}
              >
                Search
              </button>
            ...
            return (
              <button
                ...
                style={{
                  textAlign: "left",
                  cursor: "pointer",
                  background: active ? "rgba(31, 43, 36,0.08)" : "#fff",
              ...
              >
                <span
                  style={{
                    ...
                    height: 40,
                    borderRadius: 11,
                    background: active ? MKT.green : "rgba(31, 43, 36,0.10)",
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10, padding: "18px 0 4px" }}>
        ...
        <div style={{ alignSelf: "flex-start", background: "rgba(31, 43, 36,0.10)", padding: "11px 16px", borderRadius: "15px 15px 15px 4px" }}>
