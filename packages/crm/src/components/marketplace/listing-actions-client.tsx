  ...
  return (
    <>
      <div
        style={{
          background: "#fff",
          border: showFinishCheckout ? "1px solid rgba(5, 150, 105,0.45)" : "1px solid rgba(34,29,23,0.10)",
          borderRadius: 20,
          padding: 22,
          boxShadow: showFinishCheckout
            ? "0 1px 2px rgba(34,29,23,0.05),0 20px 44px rgba(5, 150, 105,0.18)"
...
function InstallCeremony({
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 200, background: MKT.dark, display: "flex", alignItems: "center", justifyContent: "center", padding: 32 }}>
      <div style={{ position: "absolute", inset: 0, background: "radial-gradient(circle at 50% 42%,rgba(5, 150, 105,0.22),transparent 58%)" }} />
      <div style={{ position: "relative", textAlign: "center", maxWidth: 460, width: "100%" }}>
        <div style={{ position: "relative", width: 120, height: 120, margin: "0 auto 30px" }}>
          <span style={{ position: "absolute", inset: 0, borderRadius: 30, background: "rgba(5, 150, 105,0.18)", animation: "sfRing 2s ease-out infinite" }} />
          <span
            style={{
              position: "absolute",
              inset: 0,
