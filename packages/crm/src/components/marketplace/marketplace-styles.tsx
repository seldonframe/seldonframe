...
const CSS = `
  ...
  @keyframes sfGlow{0%,100%{box-shadow:0 0 0 0 rgba(5, 150, 105,0.0)}50%{box-shadow:0 0 44px 6px rgba(5, 150, 105,0.28)}}
  ...
  .sf-typing span{display:inline-block;width:6px;height:6px;border-radius:99px;background:#059669;margin:0 2px;animation:sfBlink 1.1s infinite}
  .sf-typing span:nth-child(2){animation-delay:.18s}
  .sf-typing span:nth-child(3){animation-delay:.36s}
  .sf-mkt ::selection{background:rgba(5, 150, 105,0.18)}
