...
export function LandingFinalCta() {
  return (
    <section className="border-t border-zinc-800/50 py-32 text-center">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <button
          ...
          className="mt-10 inline-flex items-center gap-2 rounded-xl bg-[#14b8a6] px-10 py-4 font-semibold text-white transition-opacity hover:opacity-90"
        >
