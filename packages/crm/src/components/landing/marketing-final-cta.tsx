...
// Final CTA: deep green (--lp-cta-bg) slab, matching seldonstudio.com's
...
export function MarketingFinalCta({
  ...
  return (
    <section
      ...
      className="border-t border-[var(--lp-border-soft)] bg-[var(--lp-cta-bg)] px-5 py-24 text-center md:px-8 md:py-36 lg:px-12"
    >
      <div className="mx-auto max-w-[880px]">
        ...
        {variant === "record" ? (
          <h2 className="mx-auto mt-4 max-w-[18ch] text-[clamp(30px,5.2vw,54px)] font-[500] leading-[1.05] tracking-[-0.03em] text-[var(--lp-cta-ink)]">
            Show Seldon how you work.
          </h2>
        ) : (
          <h2 className="mx-auto mt-4 max-w-[18ch] text-[clamp(30px,5.2vw,54px)] font-[500] leading-[1.05] tracking-[-0.03em] text-[var(--lp-cta-ink)]">
            Your front office is{" "}
            <em className="font-[Newsreader,Georgia,serif] font-normal not-italic text-[color-mix(in_oklab,var(--lp-cta-ink)_75%,transparent)]">
              3 minutes away.
            </em>
          </h2>
        )}

        <p className="mx-auto mt-5 max-w-[50ch] text-[16.5px] leading-[1.55] text-[color-mix(in_oklab,var(--lp-cta-ink)_74%,transparent)]">
        ...
        <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
          {variant === "record" ? (
            <a
              href="#top"
              className="inline-flex items-center gap-2.5 rounded-full bg-[var(--lp-bg)] px-7 py-4 text-[15px] font-[500] text-[var(--lp-cta-bg)] shadow-[0_1px_2px_rgba(0,0,0,.2),0_12px_30px_rgba(0,0,0,.25),inset_0_1.5px_0_rgba(255,255,255,.6)] transition-all hover:-translate-y-[1.5px] active:translate-y-px focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--lp-accent)]"
            >
          ...
          <Link
            href="/agencies"
            className="inline-flex items-center gap-2 rounded-full border border-[rgba(255,255,255,.16)] bg-transparent px-6 py-4 text-[15px] font-[500] text-[color-mix(in_oklab,var(--lp-cta-ink)_88%,transparent)] transition-all hover:bg-[rgba(255,255,255,.08)] active:translate-y-px"
          >
            For agencies →
          </Link>
        </div>

        <p className="mt-6 font-sans text-[13px] text-[color-mix(in_oklab,var(--lp-cta-ink)_45%,transparent)]">
