      ...
      <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-12">
        ...
        <div className="text-center lg:col-span-6 lg:text-left">
          ...
          >
            ...
            <span className="text-[#1F2B24] lg:mt-1 lg:inline-block">
              Just describe it.
            </span>
          </motion.h1>
          ...
          >
            <Link
              href="/signup"
              /* a11y: text-zinc-950 on #1F2B24 = 7.2:1 (AAA). Matches
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-[#1F2B24] px-8 py-3.5 text-base font-semibold text-zinc-950 transition-all hover:scale-[1.02] hover:shadow-[0_8px_24px_-6px_rgba(31, 43, 36,0.4)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1F2B24] motion-reduce:transition-none motion-reduce:hover:scale-100"
            >
              Start free
            ...
            <Link
              href="#demo"
              className="inline-flex items-center gap-2 rounded-xl border border-zinc-700 px-7 py-3.5 text-base font-semibold text-zinc-200 transition-colors hover:border-zinc-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1F2B24]"
            >
