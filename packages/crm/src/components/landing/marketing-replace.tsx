      ...
      <div className="mx-auto max-w-[1120px]">
        ...
        <div className="mt-12 grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-5">
          ...
          <div className="rounded-[18px] border border-[rgba(34,29,23,.08)] bg-[#FFFDFA] p-6 shadow-[0_1px_2px_rgba(34,29,23,.05),0_10px_30px_rgba(34,29,23,.07)]">
            <div className="mb-5 flex items-center gap-2.5">
              <span className="inline-flex size-7 items-center justify-center rounded-md bg-[rgba(5, 150, 105,.12)] text-[#059669]">
            ...
            <ul className="m-0 flex list-none flex-col p-0">
              {SELDON.map((it, i) => (
                ...
                >
                  <Check className="text-[#059669]" size={15} strokeWidth={2.4} aria-hidden />
                  <span className="text-[13.5px] text-[#221D17]">{it.name}</span>
                  <span className={`font-mono text-[11px] ${it.highlight ? "font-[600] text-[#059669]" : "text-[#9A9183]"}`}>
                    {it.meta}
                  </span>
                </li>
              ))}
