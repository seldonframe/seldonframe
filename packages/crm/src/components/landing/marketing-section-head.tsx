...
export function MarketingSectionHead({
  ...
  return (
    ...
    >
      <div>
        <p className="m-0 mb-5 inline-flex items-center gap-2.5 font-mono text-[11.5px] font-medium uppercase tracking-[0.16em] text-[#F6F2EA] before:block before:h-px before:w-4 before:bg-current before:opacity-55">
          {eyebrow}
        </p>
